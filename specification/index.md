...
*Semantics:* Both `include` and `include-ci` take one or more
...
Returns *z*<sub>1</sub> raised to the power *z*<sub>2</sub>. For
nonzero *z*<sub>1</sub>, this is
...
positive, and an error otherwise. Similarly for 0.0<sup>*z*</sup>,
...
*Note:* These procedures were known in R<sup><small>5</small></sup>RS as exact->inexact
...
well as being compatible with R<sup><small>6</small></sup>RS.
...
> (char=? **c**h**a**r*<sub>1</sub> *c**h**a**r*<sub>2</sub> *c**h**a**r*<sub>3</sub> … *) procedure
...
> (char-ci=? **c**h**a**r*<sub>1</sub> *c**h**a**r*<sub>2</sub> *c**h**a**r*<sub>3</sub> … *) char library procedure
...
> (string=? **s**t**r**i**n**g*<sub>1</sub> *s**t**r**i**n**g*<sub>2</sub> *s**t**r**i**n**g*<sub>3</sub> … *) procedure
...
> (string-ci=? **s**t**r**i**n**g*<sub>1</sub> *s**t**r**i**n**g*<sub>2</sub> *s**t**r**i**n**g*<sub>3</sub> … *) char library procedure
...
*Note:* This procedure appears in R<sup><small>6</small></sup>RS, but places the source
...
> (string-map *proc *string<sub>1</sub>* *string<sub>2</sub>* … *) procedure
...
If *version* is equal to 5, corresponding to R<sup><small>5</small></sup>RS,
...
If *version* is equal to 5, corresponding to R<sup><small>5</small></sup>RS, the
...
All R<sup><small>7</small></sup>RS Scheme implementations have this feature.
...
#### Incompatibilities with R<sup><small>5</small></sup>RS
...
-   The R<sup><small>5</small></sup>RS procedures exact->inexact and inexact->exact
    ...
    former names are still available in the R<sup><small>5</small></sup>RS library.
...
#### Other language changes since R<sup><small>5</small></sup>RS
...
-   Various minor ambiguities and unclarities in R<sup><small>5</small></sup>RS have
    been cleaned up.
...
-   Libraries have been added as a new program structure to improve
    ...
    it is to be used. There is an R<sup><small>5</small></sup>RS compatibility library.
...
-   The R<sup><small>6</small></sup>RS procedure eof-object has been added. Eof-objects
...
-   The behavior of eqv? on inexact numbers now conforms to the
    R<sup><small>6</small></sup>RS definition.

-   When applied to procedures, eq? and eqv? are permitted to return
    different answers.

-   The R<sup><small>6</small></sup>RS procedures boolean=? and symbol=? have been
    added.
...
#### Incompatibilities with R<sup><small>6</small></sup>RS
...
-   R<sup><small>7</small></sup>RS libraries begin with the keyword define-library
...
-   There is no direct R<sup><small>6</small></sup>RS equivalent of the include,
...
-   Internal syntax definitions are allowed, but uses of a syntax form
    ...
    R<sup><small>6</small></sup>RS is not allowed.

-   The R<sup><small>6</small></sup>RS exception system was incorporated as-is, but the
...
-   The full numeric tower is optional as in R<sup><small>5</small></sup>RS, but
...
-   The semantics of map and for-each have been changed to use the SRFI
    ...
    procedures of R<sup><small>6</small></sup>RS.

-   The R<sup><small>6</small></sup>RS quasiquote clarifications have been adopted,
    with the exception of multiple-argument unquote and
    unquote-splicing.

-   The R<sup><small>6</small></sup>RS method of specifying mantissa widths was not
    adopted.

-   String ports are compatible with SRFI 6 <span class="citation"
    cites="srfi6"></span> rather than R<sup><small>6</small></sup>RS.

-   R<sup><small>6</small></sup>RS-style bytevectors are included, but only the
    ...
    cites="srfi4"></span>, rather than the R<sup><small>6</small></sup>RS #vu8 style.
...
William Clinger and Jonathan Rees, editors. The revised<sup><small>4</small></sup>
...
Jonathan Rees and William Clinger, editors. The revised<sup><small>3</small></sup>
...
editors. *The revised<sup><small>6</small></sup> report on the algorithmic language
